...
|-------|---------|---------|---------|---------|---------|-----------|
| 1-25 | 14.9% | **7.4%** | 2.4% | 11.4% | 21.9% | 0.093 |
| 26-50 | 13.2% | 16.0% | 3.6% | 11.5% | 27.4% | 0.135 |
| 51-75 | 17.2% | 35.2% | 3.5% | 8.0% | 45.1% | 0.327 |
| 76-100 | 17.7% | 38.9% | 3.0% | 7.4% | 48.1% | 0.359 |
| 101-124 | 14.6% | 44.2% | 3.0% | 8.0% | 49.9% | 0.365 |
...
> 注：step 1-225 日志实际包含 step 1-124 的逐样本数据（7980 条），step 125-200 的日志因训练重启丢失。step 201-300 为续训日志（6400 条，无缺失）。wandb 步级指标（reward、KL 等）覆盖完整 300 步，不受日志缺失影响。
